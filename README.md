...
> Built an unsupervised market-regime detection pipeline comparing Gaussian,
> Gaussian-mixture, and neural-parameterized hidden Markov models on daily
> equity, bond, volatility, and volume data; implemented causal inference,
> chronological evaluation, reproducible PyTorch training, and a transaction-cost-aware
> adaptive-allocation backtest.

Only add performance numbers after running the complete real-data experiment
and checking that those results are stable.
